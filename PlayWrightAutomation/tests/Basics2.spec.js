...
test('@Webst Client App login', async ({ page }) => {
   ...
   await page.locator("[placeholder*='Country']").pressSequentially("ind");            //page.locator("[placeholder*='Country']").pressSequentially("ind", { delay: 150 }); Here,if the application server is slow due to heavy traffic. In such cases, a delay of 150 milliseconds is introduced between each key press.
